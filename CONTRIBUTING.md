...
Welcome to `ecgen` contributor's guide.
...
If you experience bugs or general issues with `ecgen`, please have a look
...
You can help improve `ecgen` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`ecgen` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `ecgen`'s files. While this mechanism can
...
```
conda create -n ecgen python=3 six virtualenv pytest pytest-cov
conda activate ecgen
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/ecgen.git
   cd ecgen
   ```
...
5. Install [pre-commit]:
   ...
   `ecgen` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/ecgen
[issue tracker]: https://github.com/<USERNAME>/ecgen/issues
